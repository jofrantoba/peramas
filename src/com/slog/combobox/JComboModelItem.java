 ...
 * @author JONA
 */
public class JComboModelItem extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    private ArrayList<Item> data = new ArrayList();

    public JComboModelItem() {
    }

    public JComboModelItem(ArrayList<Item> datos) {
        data = datos;
    }
    ...
    public Object getElementAt(int index) {
        return (Object) data.get(index).getDescriItem();
    }
