 ...
 * @author JONA
 */
public class JComboModelProveedor extends AbstractListModel implements MutableComboBoxModel {

    private Object selectedItem;
    private ArrayList<Proveedor> data = new ArrayList();

    public JComboModelProveedor() {
    }

    public JComboModelProveedor(ArrayList<Proveedor> datos) {
        data = datos;
    }
    ...
    public Object getElementAt(int index) {
        return (Object) data.get(index).getDescriPer();
    }
